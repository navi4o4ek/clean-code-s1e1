...
var addButton=document.querySelector(".todo-app__button_add");//first button
var incompleteTaskHolder=document.querySelector(".todo-list_incomplete");//ul of #incompleteTasks
